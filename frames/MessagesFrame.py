...
class MessagesFrame(ttk.Frame):
    ...
    def add_new_message(self, new_message):
        print('Aquí estoy')
        new_message_frame = MessageFrame(self.scrollable_frame, new_message['date'], new_message['message'])
...
class MessageFrame(ttk.Frame):
    ...
    def __init__(self, container, date, message_text, **kwargs):
        ...
        self.avatar_label = ttk.Label(self, image=self.avatar_photo)
        self.avatar_label.grid(row=0, column=0, rowspan=2, sticky='NEW', padx=(0, 10), pady=(5, 0))
